...
![Sample, zoomed in, tranfer function](https://github.com/RitaSchmidt/AcousticTransferFunctionPulseqAndAnalysis/blob/main/SampleData/AnalysisOutput/Amplification_vs_Freq.png?raw=true)
